export interface OrganizationCheckSlugExistDto {
  PE_APP_ID?: number;
  PE_USER_ID: string;
  PE_TERM: string;
}
...
/**
 * Valida o DTO para verificar a existência do slug da organização
 */
export function validateOrganizationCheckSlugExistDto(
  data: unknown,
): OrganizationCheckSlugExistDto {
  ...
  // Verificação de comprimento máximo para varchar(200)
